...
$sql = "SELECT * FROM questions WHERE exam_id = '$examid' AND question = '$question'";
...
$sql = "INSERT INTO questions (question_id, exam_id, type, question, option1, option2, option3, option4, answer)
...
$sql = "INSERT INTO questions (question_id, exam_id, type, question, answer)
