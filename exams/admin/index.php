...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "Piechart presentation of USERS assessments in FAIL and PASS"
	},
	data: [{
		type: "pie",
		startAngle: 25,
		...
		indexLabel: "{label} - {y}",
		dataPoints: [
			{ y: <?php echo "$users_pass"; ?>, label: "USERS Passing Exams" },
			{ y: <?php echo "$users_fails"; ?>, label: "USERS Failing Exams" }
