                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
										   ...
										   <?php
										   include '../../db.php';
										   $sql = "SELECT * FROM assessment_records,examinations,users WHERE assessment_records.exam_id = '$exam_id' && examinations.exam_id=assessment_records.exam_id &&assessment_records.id_user = users.id_user";
                                           $result = $conn->query($sql);
